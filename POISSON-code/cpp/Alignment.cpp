 ...
 * there is a lot of duplication in the forwad and backward computation,
 * so tread lightly.
 *
 *========================================================*/
            ...
            sequence(&seq), params(par)
{
    ...
    // set the params to correct template/complement
    // errrr this is a bit hacky...
    if (event->model.complement)
        params.setComplement();
    else
        params.setTemplate();    
}
