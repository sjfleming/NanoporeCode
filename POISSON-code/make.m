function make(arg)
    ...
    switch (arg)
        ...
        case 'all'
            ...
            domake('align_likes.cpp Alignment.cpp',alignh)
            domake('MutateSequence.cpp MutateAlign.cpp Alignment.cpp',alignh)
            domake('ScoreMutations.cpp MutateAlign.cpp Alignment.cpp',alignh)
