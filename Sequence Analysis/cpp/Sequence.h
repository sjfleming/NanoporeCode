 ...
 * The first implementation is slow, will change if necessary.
 *
 *========================================================*/
...
struct Sequence
{
    ...
    // this indexing is useful though, because if the ith base changes,
    // the first state to change is the ith state
