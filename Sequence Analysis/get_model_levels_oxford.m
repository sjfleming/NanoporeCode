function pA = get_model_levels_oxford(seq, measured_levels, open_pore, voltage, temp)
...
% Stephen Fleming, 2/8/16
    ...
    polyT = open_pore * ((voltage-120)*(temp-37)/5000*[1,1] + [0.13, 0.16]); % corrects for nonlinear IV in a heuristic way...
